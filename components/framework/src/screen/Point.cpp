...
namespace sloked {
    ...
    bool SlokedGraphicsPoint::operator==(const SlokedGraphicsPoint &other) const {
    ...
    SlokedGraphicsPoint SlokedGraphicsPoint::operator+(const SlokedGraphicsPoint &other) const {
