...
namespace sloked {
    ...
    class SlokedBufferedSocket : public SlokedSocket {
     public:
        SlokedBufferedSocket(std::unique_ptr<SlokedSocket>, std::chrono::system_clock::duration, SlokedSchedulerThread &);
        bool Valid() final;
        void Close() final;
    ...
    class SlokedBufferedServerSocket : public SlokedServerSocket {
     public:
        SlokedBufferedServerSocket(std::unique_ptr<SlokedServerSocket>, std::chrono::system_clock::duration, SlokedSchedulerThread &);
    ...
    class SlokedBufferedSocketFactory : public SlokedSocketFactory {
     public:
        SlokedBufferedSocketFactory(SlokedSocketFactory &, std::chrono::system_clock::duration, SlokedSchedulerThread &);
