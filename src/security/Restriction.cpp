...
namespace sloked {
    ...
    SlokedNamedWhitelist::SlokedNamedWhitelist(std::vector<std::string> prefixes)
    ...
    std::unique_ptr<SlokedNamedWhitelist> SlokedNamedWhitelist::Make(std::vector<std::string> prefixes) {
        return std::make_unique<SlokedNamedWhitelist>(std::move(prefixes));
    }

    SlokedNamedBlacklist::SlokedNamedBlacklist(std::vector<std::string> prefixes)
        : prefixes(prefixes) {}
    ...
    std::unique_ptr<SlokedNamedBlacklist> SlokedNamedBlacklist::Make(std::vector<std::string> prefixes) {
