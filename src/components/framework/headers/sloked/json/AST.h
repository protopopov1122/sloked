...
namespace sloked {
    ...
    class JsonASTNode {
     public:
        enum class Type { Object, Array, Constant };
    ...
    class JsonConstantNode : public JsonASTNode {
     public:
        enum class DataType { Integer, Number, Boolean, String, Null };
    ...
    class JsonArrayNode : public JsonASTNode {
     public:
        JsonArrayNode(std::vector<std::shared_ptr<JsonASTNode>> &&,
                      const JsonSourcePosition &);
    ...
    class JsonObjectNode : public JsonASTNode {
     public:
        JsonObjectNode(std::map<std::string, std::unique_ptr<JsonASTNode>> &&,
                       const JsonSourcePosition &);
    ...
    class JsonASTProxyVisitor : public JsonASTVisitor<void> {
     public:
        JsonASTProxyVisitor(JsonASTVisitor<T> &visitor) : visitor(visitor) {}
