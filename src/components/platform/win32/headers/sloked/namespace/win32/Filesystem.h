...
#ifndef SLOKED_NAMESPACE_WIN32_FILESYSTEM_H_
#define SLOKED_NAMESPACE_WIN32_FILESYSTEM_H_

#include "sloked/namespace/Filesystem.h"

namespace sloked {

    class SlokedWin32FilesystemAdapter : public SlokedFilesystemAdapter {
     public:
